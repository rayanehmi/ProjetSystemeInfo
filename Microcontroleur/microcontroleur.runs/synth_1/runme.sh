...
HD_PWD='/home/rhachemi/GitHub/ProjetSystemeInfo/Microcontroleur/microcontroleur.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_UAL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_UAL.tcl
